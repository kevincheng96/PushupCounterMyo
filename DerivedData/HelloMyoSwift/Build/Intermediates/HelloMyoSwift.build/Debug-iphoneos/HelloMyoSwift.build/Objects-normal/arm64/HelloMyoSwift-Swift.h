...
SWIFT_CLASS("_TtC13HelloMyoSwift11AppDelegate")
...
@property (nonatomic) NSInteger tempCount;
@property (nonatomic) NSInteger stop;
@property (nonatomic) NSInteger start;
@property (nonatomic) NSInteger counter;
@property (nonatomic) NSInteger sum;
@property (nonatomic) NSInteger quarternionCounter;
- (void)viewDidLoad;
...
- (IBAction)stopPushUps:(id __nonnull)sender;
